        ...
        <Routes>
          ...
          <Route element={<PrivateRoute role="2" />}>
            <Route
              exact
              path="/Warden/home"
              element={<WardenPendingRequests />}
            ></Route>
            <Route
              exact
              path="/Warden/home/ApprovedCancelled"
              element={<WardenApprovedCancelled />}
            ></Route>
            <Route
              exact
              path="/Warden/home/AutoApproved"
              element={<WardenAutoApproved />}
            ></Route>
            <Route
              exact
              path="/Warden/home/VisitorRequest"
              element={<WardenVisitorRequest />}
            ></Route>
            <Route
              exact
              path="/Warden/home/VisitorRequests"
              element={<WardenReport />}
            ></Route>
            <Route
              exact
              path="/Warden/reports"
            ...
            <Route
              exact
              path="/Warden/Leave/ApplyLeave"
              element={<WardenApplyLeave />}
            ></Route>
            <Route
              exact
              path="/Warden/Leave/LeaveManagement"
              element={<WardenLeaveManagement />}
            ></Route>
          </Route>
          ...
          <Route element={<PrivateRoute role="3" />}>
            <Route
              exact
              path="/ChiefWarden/home"
              element={<ChiefWardenHome />}
            ></Route>
            <Route
              exact
              path="/ChiefWarden/home/AutoApproved"
              element={<ChiefWardenAutoApproved />}
            ></Route>
            <Route
              exact
              path="/ChiefWarden/home/Notifications"
              element={<ChiefWardenNotifications />}
            ></Route>
            <Route
              exact
              path="/ChiefWarden/home/ProfileRequests"
              element={<ChiefWardenProfileRequests />}
            ></Route>
            <Route
              exact
              path="/ChiefWarden/home/Blocked"
              element={<ChiefWardenBlocked />}
            ></Route>
            <Route
              exact
              path="/ChiefWarden/reports"
              element={<ChiefWardenReport />}
            ></Route>
            <Route
              exact
              path="/ChiefWarden/TowerAllot"
              element={<ChiefWardenTowerAllot />}
            ></Route>
          </Route>
        </Routes>
      </Router>
